...
$brainstrom['plugins']['astra-addon']['purchase_key'] = 'purchase_key';
update_option( 'brainstrom_products', $brainstrom );
wp_cache_add( 'purchase_key_license_status', true );
 ...
 */
define( 'ASTRA_THEME_MIN_VER', '3.1.0' );
